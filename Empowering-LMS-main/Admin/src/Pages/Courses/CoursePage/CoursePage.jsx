  ...
  const fetchCourseDetails = async () => {
    try {
      ...
      const response = await axiosInstance.get(
        `/courses/${courseId}/course-and-topics-summary`
      );
                ...
                <div className="flex gap-3">
                  ...
                  {!course.isGlobal && (
                    <button
                      ...
                      className="px-4 py-2.5 bg-teal-100 text-teal-700 rounded-xl font-medium hover:bg-teal-200 transition-all duration-200 cursor-pointer flex items-center gap-2 hover:shadow-sm"
                    >
        ...
        >
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            <motion.div
              ...
              className="bg-gradient-to-br from-white to-teal-50 rounded-2xl border-2 border-dashed border-teal-200 p-6 cursor-pointer hover:border-teal-300 hover:shadow-md transition-all duration-300 group"
            >
              <div className="flex items-start gap-4">
                <div className="w-14 h-14 bg-gradient-to-r from-teal-400 to-cyan-400 rounded-xl flex items-center justify-center group-hover:scale-110 transition-transform duration-300 shadow-md">
                ...
                <div className="flex-1">
                  ...
                  <p className="text-gray-600 mb-3">
                    Create engaging content for your learners with text, images,
                    videos, and more.
                  </p>
