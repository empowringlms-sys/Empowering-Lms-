...
import MediaFilesPreviewModal from "../../components/Media/MediaFilesPreviewModal";
import {
    FiUpload,
    FiFile,
    FiImage,
        ...
        <div className="min-h-screen bg-gradient-to-r from-gray-50 to-emerald-50 sm:p-4 md:p-6 lg:p-8">
                    ...
                    <div className="flex flex-col lg:flex-row justify-between items-start lg:items-center gap-3 sm:gap-4">
                        <div className="flex-1">
                            ...
                            <p className="text-emerald-700/80 text-xs sm:text-sm md:text-base">
                                Manage and organize global media assets available to all companies
                            </p>
                        </div>
                    ...
                    {statCards.map((stat) => {
                        ...
                        return (
                            <motion.div
                                ...
                                className={`relative overflow-hidden rounded-lg sm:rounded-xl md:rounded-2xl p-3 sm:p-4 cursor-pointer transition-all duration-300 cursor-pointer ${isActive
            ...
            <div className="max-w-400 mx-auto mb-6 sm:mb-8">
                <motion.div
                    ...
                    className={`relative rounded-xl sm:rounded-2xl border-2 border-dashed transition-all duration-300 cursor-pointer group ${dragOver
            ...
            <div className="max-w-400 mx-auto">
                {loading && !initialLoadDone ? (
                   ...
                   whitespace-nowrap overflow-hidden"
                        ...
                        {/* Pagination omitted for brevity as stats.pages was not fully implemented in context or ui in admin version properly, relying on fetchFiles infinite scroll or basic pagination logic */}
                        {pagination.pages > 1 && (
                            <motion.div
                                initial={{ opacity: 0 }}
                                animate={{ opacity: 1 }}
